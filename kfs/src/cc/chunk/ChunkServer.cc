...
using namespace KFS;
using namespace KFS::chunk;
using namespace KFS::libkfsio;

// single network thread that manages connections and net I/O
// global constructors and destructors in multithreaded systesm are... just plain wrong
static MetaThread *netProcessor;

ChunkServer KFS::chunk::gChunkServer;
...
void
KFS::chunk::verifyExecutingOnNetProcessor()
{
...
void
KFS::chunk::StopNetProcessor(int status)
{
...
Restarter chunk::sRestarter;

string RestartChunkServer()
{
    return chunk::sRestarter.Restart();
}
