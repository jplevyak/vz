...
void
KFS::meta::UpdateNumDirs(int count)
{
	if (gNumDirs == NULL)
		return;
...
void
KFS::meta::UpdateNumFiles(int count)
{
	if (gNumFiles == NULL)
		return;
...
void
KFS::meta::UpdateNumChunks(int count)
{
	if (gNumChunks == NULL)
		return;
 ...
 */
void
KFS::meta::ChangeIncarnationNumber(MetaRequest *r)
{
...
*/
void
KFS::meta::setClusterKey(const char *key)
{
	gClusterKey = key;
}
...
*/
void
KFS::meta::setMD5SumFn(const char *md5sumFn)
{
	gMD5SumFn = md5sumFn;
}
 ...
 */
void
KFS::meta::setWORMMode(bool value)
{
	gWormMode = value;
}

void
KFS::meta::setMaxReplicasPerFile(int16_t val)
{
	gMaxReplicasPerFile = val;
}

void
KFS::meta::setChunkmapDumpDir(string d)
{
	gChunkmapDumpDir = d;
}
...
MetaDumpChunkToServerMap::handle()
{
	...
	suspended = true;
        KFS::meta::gChildProcessTracker.Track(pid, this);
}
 ...
 */
void
KFS::meta::initialize_request_handlers()
{
	setup_handlers();
}
 ...
 */
void
KFS::meta::process_request(MetaRequest *r)
{
        r->handle();
	if (!r->suspended) {
		UpdateCounter(r->op);
 ...
 */
void
KFS::meta::submit_request(MetaRequest *r)
{
	struct timeval s, e;
 ...
 */
int
KFS::meta::ParseCommand(std::istream& is, MetaRequest **res)
{
	const char *delims = " \r\n";
